...
public @interface InsertProvider {
   ...
   * <ul>
   *   <li>
   *     If class that specified the {@link #type()} attribute implements the {@link ProviderMethodResolver},
   *     the MyBatis use a method that returned by it
   *   </li>
   *   <li>
   *     If cannot resolve a method by {@link ProviderMethodResolver}(= not implement it or it was returned {@code null}),
